...
public class RequestHolder<T> {
    ...
    public RequestHolder(AsyncHttpClient.BoundRequestBuilder httpRequestBuilder) {
        this.httpRequestBuilder = httpRequestBuilder;
        this.httpRequestBuilder.setHeader("User-Agent", "Sphere Java client");
    }

    public RequestHolder<T> addQueryParameter(String name, String value) {
        httpRequestBuilder.addQueryParameter(name, value);
        return this;
    }

    public RequestHolder<T> setBody(String requestBody) {
